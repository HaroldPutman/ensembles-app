...
@section('title', 'Art Camp')

@section('content')

<article class="mx-auto max-w-7xl px-6">

    <h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-dark sm:text-4xl text-center mb-4">Art Camp</h1>

<img src="{{ asset('image/hero/art-camp.png') }}"
alt="Art Camp"
loading="eager">
    <div class="max-w-4xl mx-auto py-12 px-4">
        <h2 class="text-3xl font-bold text-center mb-8">Reserve Your Spot</h2>
        <div class="flex justify-center">
            <a href="{{ route('register', ['classId' => 197]) }}"
