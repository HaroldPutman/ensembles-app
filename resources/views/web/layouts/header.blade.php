          ...
          <div id="hdr-about"
            ...
            <div class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
              <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                ...
                <a href="/teachers" class="-m-3 flex items-start p-3 text-gray hover:bg-gray-mist hover:text-gray-dark rounded-md focus:outline-none focus:ring-2 focus:ring-primary-light focus:ring-offset-2">
                    <p class="text-base font-medium">Our teachers</p>
                </a>
